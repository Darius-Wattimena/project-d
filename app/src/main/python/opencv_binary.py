...
img = cv2.imread('Plattegrond_v4_lowres.jpg')
im_gray = cv2.imread('Plattegrond_v4_lowres.jpg', cv2.IMREAD_GRAYSCALE)
...
np.savetxt('plattegrond.csv',img_array,fmt='%i', delimiter=',')
