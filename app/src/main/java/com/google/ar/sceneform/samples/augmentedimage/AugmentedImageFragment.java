...
public class AugmentedImageFragment extends ArFragment {
  ...
  // Naam van de image in de db.
  private static final String DEFAULT_IMAGE_NAME = "hr.png";

  // This is a pre-created database containing the sample image.
  private static final String SAMPLE_IMAGE_DATABASE = "sample_database.imgdb";


  private static final String HR_IMG_DB = "hr.db.imgdb";
  ...
  private boolean setupAugmentedImageDatabase(Config config, Session session) {
    ...
    if (USE_SINGLE_IMAGE) {
      ...
      // Laad de image database in
      try (InputStream is = getContext().getAssets().open("hr.db.imgdb")) {
